  ...
  <view class="sel-seat">
    ...
    <view class="seat-main">
            ...
            class="sm-cell" :style="'width:'+boxWidth+'px;height:'+seatSize+'px'">
          	<view v-for="(seat,col) in item" :key="col" class="dp-ib" :style="'width:'+seatSize+'px;height:'+seatSize+'px'"
          	 @click="handleChooseSeat(index,col)">
          		<image v-if="seat.type===0" class="sm-icon" src="/static/social/img/unselected.png" mode="aspectFit"></image>
          		<image v-else-if="seat.type===1" class="sm-icon" src="/static/social/img/selected.png" mode="aspectFit"></image>
          		<image v-else-if="seat.type===2" class="sm-icon" src="/static/social/img/bought.png" mode="aspectFit"></image>
          	</view>
          </view>
      ...
      <view class="fix-tips" v-if="showTis">
      	<view class="v-tips">
      		<image :style="'width:'+seatSize+'px;height:'+seatSize+'px'" src="/static/social/img/unselected.png" mode="aspectFit"></image>
          <text class="text">可选</text>
      	</view>
      	<view class="v-tips">
      		<image :style="'width:'+seatSize+'px;height:'+seatSize+'px'" src="/static/social/img/bought.png" mode="aspectFit"></image>
          <text class="text">不可选</text>
      	</view>
      	<view class="v-tips">
      		<image :style="'width:'+seatSize+'px;height:'+seatSize+'px'" src="/static/social/img/selected.png" mode="aspectFit"></image>
  ...
  export default {
    ...
    data() {
      return {
        ...
        boxWidth: 400, //屏幕宽度px
        space: ' ', //空格
        seatArray: [], //座位的二维数组,-1为非座位，0为未购座位，1为已选座位(绿色),2为已购座位(红色),一维行，二维列
        seatRow: 0, //座位行数
        seatCol: 0, //座位列数
        seatSize: 0, //座位尺寸
        SelectNum: 0, //选择座位数
