	...
	<view>
		<view>
			<view style="margin-top: 40rpx;">
			    <textarea  style="font-size: 14px;"v-model="text" @keyup="checkText()" maxlength="1000" 
		...
		<!-- <view class="limit">
			...
			<view style="margin-top:120rpx;">
				<button style="background-color: #429955;" type="primary"  class='bt' @tap="preDeliver()">发布</button>
			</view>
	</view>
</template>
<script>
