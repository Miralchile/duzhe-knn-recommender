...
* 3、支持弹幕功能
* 4、该插件采用script引入js的方式，但uni_modules中添加static文件夹需要高版本的插hbuilderX才能生效，我是用的hbuilderX版本是3.5.3，仅供大家参考，如果是低版本的hbuilderX，并且不能升级版本的话，只有将插件内的static文件夹中的文件复制到项目根目录的static文件夹中，然后在yingbing-video.vue文件中修改script引入的路径
...
| hasVideo | Boolean | false | 流中是否有视频轨道 |
